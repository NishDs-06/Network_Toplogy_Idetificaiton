...
tp_file = r"C:\Users\SANJAYRAM\OneDrive\Desktop\toposense\datasense\throughput-cell-3.dat"
...
# ---------- LOAD PACKET STATS ----------
pkt_file = r"C:\Users\SANJAYRAM\OneDrive\Desktop\toposense\datasense\pkt-stats-cell-3.dat"
...
df_pkt["loss_event"] = (df_pkt["txPackets"] > df_pkt["rxPackets"]).astype(int)
...
merged_df.to_csv("merged_cell3_updated.csv", index=False)
...
merged_df.to_csv("merged_cell3.csv", index=False)
